...
/**
 * Eatelicious toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
 ...
 */
@Composable
fun EateliciousIconToggleButton(
    checked: Boolean,
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = EateliciousIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
object EateliciousIconButtonDefaults {
