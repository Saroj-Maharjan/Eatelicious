...
<html lang="{{ config.theme.locale|default('en') }}" data-bs-theme="{{ config.theme.color_mode }}">
    <head>
      ...
      {%- block styles %}
        ...
        <link id="hljs-light" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.10.0/styles/{{ config.theme.hljs_style }}.min.css" {% if config.theme.color_mode != "light" %}disabled{% endif %}>
        <link id="hljs-dark" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.10.0/styles/{{ config.theme.hljs_style_dark }}.min.css" {% if config.theme.color_mode != "dark" %}disabled{% endif %}>
        {%- endif %}
      ...
      {%- block libs %}
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.10.0/languages/{{lang}}.min.js"></script>
        {%- endfor %}
