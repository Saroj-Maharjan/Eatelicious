package com.sawrose.eatelicious.feature.color.hct

import com.sawrose.eatelicious.feature.color.utils.ColorUtils
import com.sawrose.eatelicious.feature.color.utils.MathUtils
...
object HctSolver {
    ...
    private fun findResultByJ(hueRadians: Double, chroma: Double, y: Double): Int {
        ...
        for (iterationRound in 0..4) {
            ...
            val linrgb =
                MathUtils.matrixMultiply(doubleArrayOf(rCScaled, gCScaled, bCScaled), LINRGB_FROM_SCALED_DISCOUNT)
            // ===========================================================
            // Operations inlined from Cam16 to avoid repeated calculation
            // ===========================================================
    ...
    fun solveToInt(hueDegrees: Double, chroma: Double, lstar: Double): Int {
        var hueDegree = hueDegrees
        if (chroma < 0.0001 || lstar < 0.0001 || lstar > 99.9999) {
            return ColorUtils.argbFromLstar(lstar)
        }
        hueDegree = MathUtils.sanitizeDegreesDouble(hueDegree)
        val hueRadians = hueDegree / 180 * PI
